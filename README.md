...
This project requires the Node LTS version 12 (e.g., v12.18.3).
...
An easy step to step guide to install nvm and install node v12 on your local system is as follows:
